...
const COLD_WIND_AUDIO = '<audio src="NumberGenieEarcon_ColdWind.wav">cold wind sound</audio>';
const STEAM_ONLY_AUDIO = '<audio src="NumberGenieEarcon_SteamOnly.wav">steam sound</audio>';
const STEAM_AUDIO = '<audio src="NumberGenieEarcons_Steam.wav">steam sound</audio>';
const YOU_WIN_AUDIO = '<audio src="NumberGenieEarcons_YouWin.wav">winning sound</audio>';
